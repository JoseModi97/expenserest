...
const CategoriesViewPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: $t('edit'),
			command: (event) => { app.openPageDialog(<CategoriesEditPage isSubPage apiPath={`/categories/edit/${data.category_id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: $t('delete'),
	...
	if(pageReady){
		return (
			<div>
<main id="CategoriesViewPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('categoryDetails')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid ">
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        ...
                                        <div className="font-bold">{ item.category_id }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 md:col-4">
                            ...
                            <div className="col-12 md:col-4">
                                <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                    <div className="">
                                        <div className="text-400 font-medium mb-1">{$t('categoryName')}</div>
...
CategoriesViewPage.defaultProps = {
	id: null,
	primaryKey: 'category_id',
	pageName: 'categories',
	apiPath: 'categories/view',
