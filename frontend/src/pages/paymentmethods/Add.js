...
const PaymentmethodsAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="PaymentmethodsAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title={$t('addNewPaymentmethod')}   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
PaymentmethodsAddPage.defaultProps = {
	primaryKey: 'payment_method_id',
	pageName: 'paymentmethods',
	apiPath: 'paymentmethods/add',
	routeName: 'paymentmethodsadd',
